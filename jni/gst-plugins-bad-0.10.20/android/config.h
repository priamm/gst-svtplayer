...
/* Define to enable alsa plug-ins (used by gstalsa). */
/* #define HAVE_ALSA */
#undef HAVE_ALSA

/* Define to enable amrwb library (used by amrwbenc). */
/* #undef HAVE_AMRWB */
...
/* Define to enable exif (used by exif). */
/* #undef HAVE_EXIF */
...
/* Define to enable METADATA muxer and demuxer (used by metadata). */
/* #undef HAVE_METADATA */
...
/* Define to enable ogg theora codec (used by theoraexpdec). */
...
#define PACKAGE_STRING "GStreamer Bad Plug-ins 0.10.20"
